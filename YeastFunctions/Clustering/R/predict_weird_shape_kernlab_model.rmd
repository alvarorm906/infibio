...
yeast <- read_csv("C:\\Users\\uib\\Desktop\\spor_differentiation\\labeled\\df_combinado.csv", 
...
scaled_centered_yeast_new <- as.data.frame(scale(yeast_new[ncol(yeast)]))
...
svm_radial_model_v2 <- train(rare ~ ., data = train_data, 
                          ...
                          tuneGrid = expand.grid(C = 1.74, 
                               sigma = 0.01))
saveRDS(svm_radial_model_v2, paste0('C:\\Users\\uib\\Desktop\\spor_differentiation\\labeled\\', "classification_cells_not_wanted.rds"))
